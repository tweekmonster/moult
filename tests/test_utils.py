...
python2_stdlib = (
    '__builtin__', '__future__', '__main__', 'abc', 'aifc', 'anydbm',
    'argparse', 'array', 'ast', 'asynchat', 'asyncore', 'atexit', 'audioop',
    'base64', 'BaseHTTPServer', 'bdb', 'binascii', 'binhex', 'bisect',
    'bsddb', 'bz2', 'calendar', 'cgi', 'CGIHTTPServer', 'cgitb', 'chunk',
    'cmath', 'cmd', 'code', 'codecs', 'codeop', 'collections', 'colorsys',
    'compileall', 'ConfigParser', 'contextlib', 'Cookie', 'cookielib',
    'copy', 'copy_reg', 'cPickle', 'cProfile', 'cStringIO', 'csv', 'ctypes',
    'curses', 'datetime', 'dbhash', 'decimal', 'difflib', 'dis',
    'distutils', 'doctest', 'DocXMLRPCServer', 'dumbdbm', 'dummy_thread',
    'dummy_threading', 'email', 'encodings', 'ensurepip', 'errno',
    'exceptions', 'filecmp', 'fileinput', 'fnmatch', 'formatter',
    'fractions', 'ftplib', 'functools', 'future_builtins', 'gc', 'getopt',
    'getpass', 'gettext', 'glob', 'gzip', 'hashlib', 'heapq', 'hmac',
    'hotshot', 'htmlentitydefs', 'HTMLParser', 'httplib', 'imaplib',
    'imghdr', 'imp', 'importlib', 'inspect', 'io', 'itertools', 'json',
    'keyword', 'lib2to3', 'linecache', 'locale', 'logging', 'macpath',
    'mailbox', 'mailcap', 'marshal', 'math', 'mimetypes', 'mmap',
    'modulefinder', 'multiprocessing', 'netrc', 'nntplib', 'numbers',
    'operator', 'os', 'parser', 'pdb', 'pickle', 'pickletools', 'pkgutil',
    'platform', 'plistlib', 'poplib', 'pprint', 'profile', 'pstats',
    'py_compile', 'pyclbr', 'pydoc', 'Queue', 'quopri', 'random', 're',
    'rlcompleter', 'robotparser', 'runpy', 'sched', 'select', 'shelve',
    'shlex', 'shutil', 'signal', 'SimpleHTTPServer', 'SimpleXMLRPCServer',
    'site', 'smtpd', 'smtplib', 'sndhdr', 'socket', 'SocketServer',
    'sqlite3', 'ssl', 'stat', 'string', 'StringIO', 'stringprep', 'struct',
    'subprocess', 'sunau', 'symbol', 'symtable', 'sys', 'sysconfig',
    'tabnanny', 'tarfile', 'telnetlib', 'tempfile', 'test', 'textwrap',
    'thread', 'threading', 'time', 'timeit', 'Tix', 'Tkinter', 'token',
    'tokenize', 'trace', 'traceback', 'ttk', 'turtle', 'types',
    'unicodedata', 'unittest', 'urllib', 'urllib2', 'urlparse', 'UserDict',
    'UserList', 'UserString', 'uu', 'uuid', 'warnings', 'wave', 'weakref',
    'webbrowser', 'whichdb', 'wsgiref', 'xdrlib', 'xml', 'xmlrpclib',
